...
function setup() {
  ...
  //mudando todos os sprites, adicionando um height ou width para acompanhar o tamanho da tela do usuario
...
function draw() {
  ...
  if (gameState===PLAY){
    ...
    //adicionando um touch para celulares
    //touches maior que 0 então alguem tocou na tela
